...
class PDF extends FPDF
{
	...
	function TablaBasica($header,$result)
	{
		...
		while($rowp = mysqli_fetch_array($result)){
			$this->Cell(40,5,$rowp['rut_secretaria'],1);
			$this->Cell(40,5,$rowp['nombre'],1);
			$this->Cell(40,5,$rowp['apellido'],1);
    ...
    {
        $txt = "Reporte informativo sobre las secretarias que ejercen actualmente en la consulta";
